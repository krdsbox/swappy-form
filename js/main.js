function validateLogin() {
	...
	if(emailid == null || emailid == '') {
		document.getElementById('errors').innerHTML = "Email should not be empty!";
	...
	if(password == null || password == '') {
		document.getElementById('errors').innerHTML = "Password should not be empty!";
...
function validateRegister() {
	...
	if (username == null || username == '') {
		document.getElementById('registererrors').innerHTML = 'Username should not be empty!';
		document.registerform.username.focus();
		return false;
	}
	if(username.length < 6 ) {
		document.getElementById('registererrors').innerHTML = "Username should not be short!";
		document.registerform.username.focus();
		return false;
	}

	if(password == null || password == '') {
		document.getElementById('registererrors').innerHTML = "Password should not be empty!";
		document.registerform.password.focus();
		return false;
	}

	if(password.length < 6 ) {
		document.getElementById('registererrors').innerHTML = "Password should not be short!";
		document.registerform.password.focus();
		return false;
	}
	...
	if(emailid == null || emailid == '') {
		document.getElementById('registererrors').innerHTML = "Email id should not be empty!";
...
$(document).ready(function(){
	...
	/* tab code */
	$(".formCtlWrapper a, a.register").click(function() {
